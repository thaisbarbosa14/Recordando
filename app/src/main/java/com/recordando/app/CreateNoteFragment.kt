...
import com.recordando.app.database.NotesDatabase
import com.recordando.app.entities.Notes
import com.recordando.app.util.NoteBottomSheetFragment
...
class CreateNoteFragment : BaseFragment(),EasyPermissions.PermissionCallbacks,EasyPermissions.RationaleCallbacks{
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        btnOk.setOnClickListener {
            if (etWebLink.text.toString().trim().isNotEmpty()){
                ...
                Toast.makeText(requireContext(),"insira um Link",Toast.LENGTH_SHORT).show()
            }
        }
    ...
    private fun updateNote(){
        launch {
            ...
            context?.let {
                ...
                notes.subTitle = nomeI.text.toString()
    ...
    private fun saveNote(){
        ...
        if (etNoteTitle.text.isNullOrEmpty()){
            Toast.makeText(context,"Insira um titulo",Toast.LENGTH_SHORT).show()
        }
        else if (nomeI.text.isNullOrEmpty()){

            Toast.makeText(context,"Insira um sub titulo",Toast.LENGTH_SHORT).show()
        }
    ...
    private fun checkWebUrl(){
        if (Patterns.WEB_URL.matcher(etWebLink.text.toString()).matches()){
            ...
            Toast.makeText(requireContext(),"Link inválido",Toast.LENGTH_SHORT).show()
        }
    }
